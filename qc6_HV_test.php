<?php
    ...
    <strong>Well done!</strong> You successfully generated XML file for QC6 data 
		  </div>';
...
<?php include "side.php"; ?>
	  ...
	  <h2 class="sub-header"> <img src="images/ROPCB.png" width="4%"> <span class="glyphicon glyphicon-plus" aria-hidden="true"></span> HV Test  </h2>
    ...
    <span class="glyphicon glyphicon-exclamation-sign" aria-hidden="true"></span><strong>Error!</strong> Please fill the required fields.
	      ...
	      <form method="POST" action="convert_qc6_HV.php" enctype='multipart/form-data'>
		   ...
		   <div class="form-group">
			...
			<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
		      <!-- <p class="help-block">help text here.</p>--> 
		       ...
		       <input class="foils" href="#" name="CHAMBER" value="" hidden/> 
