               ...
               include_once "functions/functions.php";
                ...
                if (isset($_POST['serial'])) {
                    ...
                    if (isset($_POST['barcode']) && !empty($_POST['barcode'])) {
                        ...
                        $kindOfPart = $DRIFT_KIND_OF_PART_NAME;
                        //echo  $kindOfPart;
...
<div class="container-fluid" >
    <div class="row">
      ...
      <span class="glyphicon glyphicon-exclamation-sign" aria-hidden="true"></span><strong>Error!</strong> Please fill the required fields.
                ...
                <form method="POST" action="new_drift.php">

                    <div class="row">
                        <div class="col-xs-6 panel-info panel" style="padding-left: 0px; padding-right: 0px;">
                            <div class="panel-heading">
                                <h3 class="panel-title" >  <span aria-hidden="true" class="glyphicon glyphicon-info-sign"></span>Drift Information</h3>
                            </div>
                            <div class="panel-body">
                            <!-- <span class="text-muted">List single chambers</span> -->
                                <div class="form-group">
                                    <label for="exampleInputEmail1" style="float: left;">Serial Number:&nbsp;</label>
                                    <!--<div class="serial"><span class="name">PCB-DR-B<span class="batch">1</span>-<span id="vers" class="version">VERSION</span><span class="id">-XXXX</span></div>-->
                                    <div class="serial"><span class="name">PCB-VIII-DR<span class="batch"></span>-<span id="vers" class="version">VERSION</span><span class="id">-XXXX</span></div>
...
<script>
    $(document).ready(function () {
         ...
         */
        $.ajax({
            url: 'functions/ajaxActions.php?kindid=<?= $DRIFT_KIND_OF_PART_ID; ?>',
        ...
        function ajaxCall() {
            if ($("#vers").text() == "L-") {
                $.ajax({
                    url: 'functions/ajaxActions.php?kindid=<?= $DRIFT_KIND_OF_PART_ID; ?>&version=-L-',
                ...
                $.ajax({
                    url: 'functions/ajaxActions.php?kindid=<?= $DRIFT_KIND_OF_PART_ID; ?>&version=-S-',
                    success: function (data) {
                        $(".id").text(data);
                        $(".serialInput").val($(".serial").text());
                    }
