...
def xml_from_excel3(excel_file):
	...
	root = generateXMLHeader("QC3_GAS_LEAK_CALIB","GEM Chamber QC3 Gas Leak Calib Data","CERN Station A GEM QC3 Gas Leak Data",Run,Start,Stop,comment,location,user)
	...
	File=sys.argv[9]
	#Comments=sys.argv[10]
	root = generateXMLHeader("QC3_GAS_LEAK_CALIB_SUMRY","GEM Chamber QC3 Gas Leak Calib Summary","CERN Station QC3 Gas Leak Data Summary",Run,Start,Stop,comment, location,user)
	dataSet = generateDataSet(root,Comments,"1","GEM Chamber",chamber)
