...
<div class="container-fluid" >
    <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            <h2 class="sub-header"> <img src="images/VFAT_1.PNG" width="4%"> <span class="glyphicon glyphicon-plus" aria-hidden="true"></span> New VFAT  </h2>
                    ...
                    <div class="row">
                        <div class="col-xs-6 panel-info panel" style="padding-left: 0px; padding-right: 0px;">
                            <div class="panel-heading">
                                <h3 class="panel-title" >  <span aria-hidden="true" class="glyphicon glyphicon-info-sign"></span>VFAT Information</h3>
                            </div>
                            <div class="panel-body">
                            <!-- <span class="text-muted">List single chambers</span> -->
                                <div class="form-group">
                                    <label for="exampleInputEmail1" style="float: left;">Serial Number:&nbsp;</label>
                                    <div class="serial"><span class="name">VFAT-VI-</span><span id="vers" class="version" >VERSION</span><span class="id">-XXXX<?php /* str_pad($serial_num[3] + 1, 4, 0, STR_PAD_LEFT); */ ?></span></div>
