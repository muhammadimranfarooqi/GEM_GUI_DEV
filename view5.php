...
//$conn = oci_connect("CMS_GEM_APPUSER_R", "GEM_Reader_2015", "int2r1-v.cern.ch:10121/int2r.cern.ch");
//$conn = oci_connect("CMS_GEM_APPUSER_R", "GEM_Reader_2015", "cmsonr1-adg1-s.cern.ch:10121/cms_omds_adg.cern.ch");
  if (!$conn)
  {
     $m = oci_error();
     echo $m['message'], "\n";
...
$q="Select count(*) as total from CMS_GEM_MUON_VIEW.GEM_QC2_FAST_DATA_VIEW";
//$q="Select count(*) as total from cms_gem_muon_view.gem_suprchmbr_vfat_view";
...
if($c%100==0)
  ...
  for($count=1;$count<=$c;$count++)
  {
    ...
    echo "<a href=\"#\" onClick='ajfunc(\"GEM_QC2_FAST_DATA_VIEW\",$count)'>$count</a>";
  }
