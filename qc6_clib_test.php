<?php
	  ...
	  if (isset($_POST['foilsnumbersubmitted'])) {
		  ...
		  $partdata['HUMIDITY_PERCENT'] = $_POST['HUMIDITY_PERCENT_foil'.$i];
		  $partdata['TEMP_DEG_CENT'] = $_POST['TEMP_DEG_CENT_foil'.$i];
		  $partdata['PRESSURE_MBAR'] = $_POST['PRESSURE_MBAR_foil'.$i];
		  $foil['DATA'] = $partdata;
...
<?php include "side.php"; ?>
    ...
    <span class="glyphicon glyphicon-exclamation-sign" aria-hidden="true"></span><strong>Error!</strong> Please fill the required fields.
	      ...
	      <form method="POST" action="qc2_fast_amb.php">
		  ...
		  <div class="row">
		   ...
		   <div class="form-group">
			...
			<div class="panel-body">
				  ...
				  <div class="form-group">
				      <label> Upload Data! <i class="ace-icon glyphicon glyphicon-barcode"></i></label><br>
