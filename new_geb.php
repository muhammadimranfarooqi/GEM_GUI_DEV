...
<div class="container-fluid" >
    <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            <h2 class="sub-header"><img src="images/foil2.png" width="4%"> <span class="glyphicon glyphicon-plus" aria-hidden="true"></span> New GEM Electronic Board GEB  </h2>
<?php
      ...
      <span class="glyphicon glyphicon-exclamation-sign" aria-hidden="true"></span><strong>Error!</strong> Please fill the required fields.
                ...
                <form method="POST" action="new_geb.php">

                    <div class="row">
                        <div class="col-xs-6 panel-info panel" style="padding-left: 0px; padding-right: 0px;">
                            <div class="panel-heading">
                                <h3 class="panel-title" >  <span aria-hidden="true" class="glyphicon glyphicon-info-sign"></span>GEB Information</h3>
                            </div>
                            <div class="panel-body">
                            <!-- <span class="text-muted">List single chambers</span> -->
                                <div class="form-group">
                                    <label for="exampleInputEmail1" style="float: left;">Serial Number:&nbsp;</label>
                                    <div class="serial"><span class="name">GEB-RO-</span><span id="vers" class="version">VERSION</span><span class="id">-XXXX</span></div>
...
<script>
    $(document).ready(function () {
         ...
         */
        $.ajax({
            url: 'functions/ajaxActions.php?kindid=<?= $GEB_KIND_OF_PART_ID; ?>',
        ...
        function ajaxCall() {
            if ($("#vers").text() == "L-") {
                $.ajax({
                    url: 'functions/ajaxActions.php?kindid=<?= $GEB_KIND_OF_PART_ID; ?>&version=-L-',
                ...
                $.ajax({
                    url: 'functions/ajaxActions.php?kindid=<?= $GEB_KIND_OF_PART_ID; ?>&version=-S-',
                    success: function (data) {
                        $(".id").text(data);
                        $(".serialInput").val($(".serial").text());
                    }
