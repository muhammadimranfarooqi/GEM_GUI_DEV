...
//echo "test". $position;
 ...
 // geb -> readout
        ...
        // vfat -> geb
            ...
            $serialarr = getSerialById($row['PART_ID']);
            $serial = $serialarr[0]['SERIAL_NUMBER'];
            echo '<li class="list-group-item" style="white-space:nowrap"><label> GEB NARROW:</label> <a href="show_geb.php?id=' . $serial . '">' . $serial . '</a>  </li>';
        }
            ...
            $serialarr = getSerialById($row['PART_ID']);
            $serial = $serialarr[0]['SERIAL_NUMBER'];
            echo '<li class="list-group-item" style="white-space:nowrap"><label> GEB WIDE:</label> <a href="show_geb.php?id=' . $serial . '">' . $serial . '</a>  </li>';
        }

else if ($row['RELATIONSHIP_ID'] === $COOLING_PLATE_TO_CHAMBER) {
            $serialarr = getSerialById($row['PART_ID']);
            $serial = $serialarr[0]['SERIAL_NUMBER'];
            echo '<li class="list-group-item" style="white-space:nowrap"><label>COOLING PLATE:</label> <a href="show_cooling_plate.php?id=' . $serial . '">' . $serial . '</a>  </li>';
        }
...
//echo "test". $position;
 ...
 $positionarr = get_attribute_position($row['PART_ID'], $relationship_id_foil_position);
            ...
            echo '<li class="list-group-item" style="white-space:nowrap"><label> VFAT2 at Position: '. $position .'. </label> <a href="show_vfat.php?id=' . $serial . '">' . $serial . '</a> <a style="color: red; padding-left:4em " href="javascript:void(0);" class="detach" id="' . $serial . '" kind="' . $VFAT_KIND_OF_PART_NAME . '"><span aria-hidden="true" class="glyphicon glyphicon-resize-full"></span> Detach <span aria-hidden="true" class="glyphicon glyphicon-remove"></span></a> </li>';
        }
            ...
            $serialarr = getSerialById($row['PART_ID']);
            $serial = $serialarr[0]['SERIAL_NUMBER'];
            echo '<li class="list-group-item" style="white-space:nowrap"><label> GEB NARROW:</label> <a href="show_geb.php?id=' . $serial . '">' . $serial . '</a> <a style="color: red; padding-left:4em " href="javascript:void(0);" class="detach" id="' . $serial . '" kind="' . $GEB_NARROW_KIND_OF_PART_NAME . '"><span aria-hidden="true" class="glyphicon glyphicon-resize-full"></span> Detach <span aria-hidden="true" class="glyphicon glyphicon-remove"></span></a> </li>';
        }
            ...
            $serialarr = getSerialById($row['PART_ID']);
            $serial = $serialarr[0]['SERIAL_NUMBER'];
            echo '<li class="list-group-item" style="white-space:nowrap"><label> GEB WIDE:</label> <a href="show_geb.php?id=' . $serial . '">' . $serial . '</a> <a style="color: red; padding-left:4em " href="javascript:void(0);" class="detach" id="' . $serial . '" kind="' . $GEB_WIDE_KIND_OF_PART_NAME . '"><span aria-hidden="true" class="glyphicon glyphicon-resize-full"></span> Detach <span aria-hidden="true" class="glyphicon glyphicon-remove"></span></a> </li>';
        }

else if ($row['RELATIONSHIP_ID'] === $COOLING_PLATE_TO_CHAMBER) {
            $serialarr = getSerialById($row['PART_ID']);
            $serial = $serialarr[0]['SERIAL_NUMBER'];
            echo '<li class="list-group-item" style="white-space:nowrap"><label>COOLING PLATE:</label> <a href="show_cooling_plate.php?id=' . $serial . '">' . $serial . '</a> <a style="color: red; padding-left:4em " href="javascript:void(0);" class="detach" id="' . $serial . '" kind="' . $COOLING_PLATE_KIND_OF_PART_NAME . '"><span aria-hidden="true" class="glyphicon glyphicon-resize-full"></span> Detach <span aria-hidden="true" class="glyphicon glyphicon-remove"></span></a> </li>';
        }
