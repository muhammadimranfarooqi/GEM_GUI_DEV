<?php
    ...
    Zip File was sent to dbloader :  <strong>ID:</strong> ' . $_POST['serial'] .
...
<?php include "side.php"; ?>
	  ...
	  <h2 class="sub-header"> <img src="images/ROPCB.png" width="4%"> <span class="glyphicon glyphicon-plus" aria-hidden="true"></span>  Gain Uniformity Test  </h2>
    ...
    <span class="glyphicon glyphicon-exclamation-sign" aria-hidden="true"></span><strong>Error!</strong> Please fill the required fields.
	      ...
	      <form method="POST" action="convert_qc5_gain_unif.php" enctype='multipart/form-data'>
		  ...
		  <div class="row">
		   ...
		   <div class="form-group">
			...
			<div class="panel-body">
				     ...
				     <div class="form-group">
                                      <label> Select Root File <i class="ace-icon glyphicon glyphicon-barcode"></i></label><br>
                                        <input type="file" name="root_file" id="root_file" onchange="checkrootfile(this);" required/>
                                     </div>

<div class="form-group">
                                      <label> Select Plot File 1: <i class="ace-icon glyphicon glyphicon-barcode"></i></label><br>
                                        <input type="file" name="plot_file1" id="plot_file1" onchange="checkfile(this);" required/>
                                     </div>
<div class="form-group">
                                      <label> Select Plot File 2: <i class="ace-icon glyphicon glyphicon-barcode"></i></label><br>
                                        <input type="file" name="plot_file2" id="plot_file2" onchange="checkfile(this);" required/>
                                     </div>
<div class="form-group">
                                      <label> Select Plot File 3: <i class="ace-icon glyphicon glyphicon-barcode"></i></label><br>
                                        <input type="file" name="plot_file3" id="plot_file3" onchange="checkfile(this);" required/>
                                     </div>
<div class="form-group">
                                      <label> Select Plot File 4:<i class="ace-icon glyphicon glyphicon-barcode"></i></label><br>
                                        <input type="file" name="plot_file4" id="plot_file4" onchange="checkfile(this);" required/>
                                     </div>
<div class="form-group">
                                      <label> Select Plot File 5:<i class="ace-icon glyphicon glyphicon-barcode"></i></label><br>
                                        <input type="file" name="plot_file5" id="plot_file5" onchange="checkfile(this);" required/>
                                     </div>

<div class="form-group">
                                      <label> Select Plot File 6:<i class="ace-icon glyphicon glyphicon-barcode"></i></label><br>
                                        <input type="file" name="plot_file6" id="plot_file6" onchange="checkfile(this);" required/>
                                     </div>
...
function checkfile(sender) {
    var validExts = new Array(".jpg", ".png", ".gif",".bmp",".tiff");
...
function checkrootfile(sender) {
    var validExts = new Array(".root");
    var fileExt = sender.value;
    fileExt = fileExt.substring(fileExt.lastIndexOf('.'));
    if (validExts.indexOf(fileExt) < 0) {
