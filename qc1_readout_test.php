...
<?php include "side.php"; ?>
	  ...
	  <h2 class="sub-header"> <img src="images/ROPCB.png" width="4%"> <span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Readout Test  </h2>
    ...
    <span class="glyphicon glyphicon-exclamation-sign" aria-hidden="true"></span><strong>Error!</strong> Please fill the required fields.
		  ...
		  <div class="row">
			  ...
			  <div class="panel-heading">
			      <h3 class="panel-title" >  <span aria-hidden="true" class="glyphicon glyphicon-info-sign"></span>On which Readout test performed?</h3>
			  </div>
<!--			  <div class="panel-body">
		<div style="white-space:nowrap">
                                                        <label for="exampleInputFile">Related Readout: </label>
                                                        ...
                                                        multiple=""-->
                                                        <!--<select tabindex="-1"  class="chosen-select-foil-<?= $i ?>" style="" data-placeholder="Choose READOUT">
                                                            <option value=""></option>
                                                            <optgroup label="Foil">
                                                                <?php
                                                                $arr = list_parts($READOUT_KIND_OF_PART_ID);
 ...
 <div class="panel-body">
		   <div class="form-group">
		       <label for="exampleInputEmail1">Choose Readout:&nbsp;</label>
			...
			<div class="dropdown"  scrollable-menu>
			   ...
			   <ul class="dropdown-menu scrollable-menu"  aria-labelledby="dropdownMenu1">
					...
					<?php list_parts($READOUT_KIND_OF_PART_ID); ?>
			  </ul>
		       </div>
			</div>
