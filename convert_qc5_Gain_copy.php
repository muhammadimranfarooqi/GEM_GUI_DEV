...
$outs = trim($out);
$output=shell_exec("/afs/cern.ch/user/mimran/mimran/www/dev/my_env_new/bin/python QC5_Gain_Data.py '$FileName' '$CHAMBER' $outs '$LOCATION' '$INITIATED_BY_USER' '$COMMENT_DESCRIPTION' '$RUN_BEGIN_TIMESTAMP' '$RUN_END_TIMESTAMP' '$Elog' '$Files' '$comments'");
